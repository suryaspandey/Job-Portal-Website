          ...
          <div className=" bg-black max-w-5xl">
            <div className="relative grid grid-cols-1 md:grid-cols-2  justify-between p-6">
              <div className="flex-col items-center">
                <h2 className="text-3xl md:text-5xl text-center md:text-left font-bold text-white mb-4">
                ...
                <div className="relative w-full max-w-xl mx-auto">
                  ...
                  />
                  <button className="absolute right-1 top-1 bottom-1 px-2 md:px-6 rounded-full bg-primary text-white font-medium hover:bg-primary/90 transition-all duration-200">
                    Subscribe
                  </button>
                </div>
              </div>
